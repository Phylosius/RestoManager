...
public class Order {
    ...
    // don't work properly
    public void addDishOrder(DishOrder dishOrder, StockMovementDAO stockMovementDAO){
        List<MakeUp> missingMakeUps = dishOrder.getMissingIngredients(LocalDateTime.now(), stockMovementDAO);
