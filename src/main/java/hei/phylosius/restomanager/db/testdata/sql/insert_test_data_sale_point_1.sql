...
-- MOVEMENT_STOCK sale point 1
INSERT INTO stock_movement(ingredient_id, type, quantity, date) VALUES
    -- IN
    ('3', 'IN', 100.0, '2025-04-01 08:00'),
    ('4', 'IN', 50.0, '2025-04-01 08:00'),
    ('1', 'IN', 20000.0, '2025-04-01 08:00'),
    ('2', 'IN', 20.0, '2025-04-01 08:00'),
    -- OUT
    ('2', 'OUT', 1.5, '2025-04-01 10:00'),
    ('3', 'OUT', 49.0, '2025-04-01 10:00');

-- INGREDIENT PRICE sale point 1
INSERT INTO ingredient_price (ingredient_id, unit_price, date) VALUES
    ('1', 10, '2025-04-01 08:00'),
    ('2', 15000, '2025-04-01 08:00'),
    ('3', 1000, '2025-04-01 08:00'),
    ('4', 500, '2025-04-01 08:00');

-- ORDER sale point 1
INSERT INTO "order"(id, reference, created_at) VALUES
    ('1', 'CMD-001',  '2025-01-02 19:32'),
    ('2', 'CMD-002','2025-01-02 19:38'),
    ('3', 'CMD-003','2025-01-02 19:40');

-- DISH_ORDER sale point 1
...
-- DISH_ORDER_STATUS_HISTORY sale point 1
